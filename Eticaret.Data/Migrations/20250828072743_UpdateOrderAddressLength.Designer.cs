...
namespace Eticaret.Data.Migrations
{
    ...
    [Migration("20250828072743_UpdateOrderAddressLength")]
    partial class UpdateOrderAddressLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 8, 28, 10, 27, 41, 919, DateTimeKind.Local).AddTicks(6429),
                            Email = "ilyas@gmail.com",
                            IsActive = true,
                            IsAdmin = true,
                            Name = "Ilyas",
                            Password = "$2a$12$JJPzDld8ofRYVM1/Qgosi.LZ1XVTUVhuo40Vz5MNMy8dUVhTmgR8u",
                            Surname = "Turanli",
                            UserGuid = new Guid("46aa2e0c-a27e-497e-a8fa-d85e60e293ff"),
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 8, 28, 10, 27, 42, 281, DateTimeKind.Local).AddTicks(5061),
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Elektronik",
                            OrderNo = 1,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 8, 28, 10, 27, 42, 281, DateTimeKind.Local).AddTicks(6414),
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Bilgisayar",
                            OrderNo = 2,
            ...
            modelBuilder.Entity("Eticaret.Core.Entities.Order", b =>
                {
                    b.HasOne("Eticaret.Core.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("AppUserId")
