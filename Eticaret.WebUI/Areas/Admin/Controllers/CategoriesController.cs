...
namespace Eticaret.WebUI.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            // burdan ıd ve name gösteriyoruz sadece..
            return View();
        }
        ...
        //<input asp-for="Image" class="form-control" type="file"/> burda create.cshtmldeki asp-for= Image oldugu icin IFormFile? Image yazıyoruz...
        {
        ...
        public async Task<IActionResult> Edit(int id,Category category,IFormFile? Image,bool cbResimSil = false)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        var newFileName = await FileHelper.FileLoaderAsync(Image, "/Img/Categories/");
                        if (!string.IsNullOrEmpty(existingCategory.Image))
                        {
                            FileHelper.FileRemover(existingCategory.Image, "/Img/Categories/");
                        }
